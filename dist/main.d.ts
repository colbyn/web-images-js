...
declare type ImageFormat = "jpeg" | "jpg" | "png" | "gif" | "webp" | "pnm" | "tiff" | "tga" | "bmp" | "ico" | "hdr";
...
export declare function contrast(image: Image, contrast: Number): Promise<Image>;
...
export declare function save(image: Image, path: String): Promise<Image>;
export declare function save_with_format(image: Image, path: String, format: ImageFormat): Promise<Image>;
export declare function map_rgba(image: Image, f: (x: number, y: number, px: Array<number>) => Array<number>): Promise<Image>;
export declare function reduce_rgba<T>(image: Image, initial_value: T, f: (accumulator: T, x: number, y: number, px: Array<number>) => T): Promise<Image>;
export declare function map_luma(image: Image, f: (x: number, y: number, px: number) => number): Promise<Image>;
export declare function reduce_luma<T>(image: Image, initial_value: T, f: (accumulator: T, x: number, y: number, px: number) => T): Promise<Image>;
export declare function grayimage_u32_map(image: GrayImageU32, f: (x: number, y: number, px: number) => number): Promise<GrayImageU32>;
export declare function grayimage_u32_reduce<T>(image: GrayImageU32, initial_value: T, f: (accumulator: T, x: number, y: number, px: number) => T): Promise<GrayImageU32>;
export declare function grayimage_u32_to_image<T>(image: GrayImageU32): Promise<Image>;
...
export declare function connected_components(image: Image, conn: String, background: Number): Promise<Image>;
export declare function shrink_width(image: Image, target_width: String): Promise<Image>;
export {};
