...
export function vertical_filter(image: Image, kernel: Array<Number>): Promise<Image> {
    return foreign.vertical_filter(image, undefined);
}
...
export function gaussian_noise(image: Image, mean: Number, stddev: Number, seed: Number): Promise<Image> {
    return foreign.gaussian_noise(image, undefined);
}

export function salt_and_pepper_noise(image: Image, rate: Number, seed: Number): Promise<Image> {
    return foreign.salt_and_pepper_noise(image, undefined);
}

export function connected_components(image: Image, conn: String, background: Number): Promise<Image> {
    return foreign.connected_components(image, undefined);
}

export function shrink_width(image: Image, target_width: String): Promise<Image> {
    return foreign.shrink_width(image, undefined);
}
